...
const Biography = () => {
  return <section className="py-12 md:py-16 lg:py-24 px-4 md:px-6 lg:px-8 xl:px-16 bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-4 md:text-base leading-relaxed text-sm font-normal">Sanjeev Khandekar's multifaceted persona extends beyond the visual arts - a polymath with credentials in literature and activism, he brings a critical lens to their visual output. He is a respected poet, writer, social activist, and passionate gardener. Vaishali Narkar who is a formally trained artist from Sir J.J. College of Art, provides the technical and aesthetic rigor.</p>
            </div>
