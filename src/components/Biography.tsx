      ...
      <div className="portfolio-container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-2 lg:order-1">
            <SectionTitle title="About Vaishali & Sanjeev" className="mb-6" />
            
            <div className="mb-6">
              <h3 className="text-lg md:text-xl font-sans font-bold mb-4">The Uncommon Alliance</h3>
              <p className="text-gray-700 mb-4 text-sm md:text-base leading-relaxed">Artistic collaboration, while not novel, rarely sustains itself as a primary mode of practice. For two decades, Sanjeev Khandekar and Vaishali Narkar have defied this norm, forging a dynamic partnership that has yielded a diverse and compelling body of work; that dissects the complexities of the 21st century.</p>
            </div>
