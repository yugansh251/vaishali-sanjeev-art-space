  ...
  return (
    <section className="section-padding bg-white" id="contact">
      <div className="portfolio-container">
        <SectionTitle 
          title="Get in Touch" 
          subtitle="Feel free to reach out for collaborations, inquiries, or just to say hello."
          centered
        />
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">contact@vaishalisanjeev.com</p>
                </div>
              </div>
            ...
            <div className="flex space-x-6">
              <a 
                ...
                className="bg-white w-12 h-12 rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-shadow border border-gray-100 hover:border-portfolio-blue/20"
              >
